...
- [ ] 4.1 Add service tests for registry operations, dynamic options, and ownership conflict detection
- [ ] 4.2 Add MCP tests for the new registry tools and merged starter-pack discovery/apply contracts
